...
int main()
{
    ...
    do
    {
        ...
        {
            case 1:
                addEmployee(arrayEmployees,LENGTH,nextId,arrayEmployees->name,arrayEmployees->lastName,arrayEmployees->salary,arrayEmployees->sector);
                nextId++;
                option1=1;
                break;
            case 2:
                if(option1)
                {
                    editEmployee(arrayEmployees, LENGTH, arrayEmployees->id);
                }
                else
                {
            ...
            case 3:
                if(option1)
                {
                    removeEmployee(arrayEmployees, LENGTH, arrayEmployees->id);
                }
                else
                {
